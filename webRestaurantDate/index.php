...
<!-- START: Page Contents -->
    ...
    <!-- END: Page Top Image -->
        <!-- START: links for mobile -->
        <div class="home_top_links_mb d768_mb">
            <div class="home_top_rest"><a href="findRestraunts.php">FIND RESTAURANTS</a></div>
            <div class="home_top_love"><a href="signUpPg1.php">FIND YOUR LOVE</a></div>
            <div class="home_top_join"><a href="signUpPg1.php">JOIN AS RESTAURANT</a></div>
        </div>
    ...
    <!-- START: Services List -->
    <section>
        <div class="home_sList gs_reveal gs_reveal_fromBottom">
            ...
            <div class="home_sList_block gs_reveal gs_reveal_fromBottom">
    ...
    <section class="restMarginBottom_mb">
        <div class="home_joinNow">
            <div class="home_joinNow_bg">
                <div class="home_joinNow_bg_cover"></div>
            </div>
            <div class="home_joinNow_contents">
                <div class="home_joinNow_img gs_reveal gs_reveal_fromLeft"></div>
                <div class="home_joinNow_text gs_reveal gs_reveal_fromRight">
    ...
    <!-- START: JOIN NOW for users -->
    <section class="restMarginTop_mb">
        <div class="home_restJoin">
            <div class="home_restJoin_text gs_reveal gs_reveal_fromLeft">
